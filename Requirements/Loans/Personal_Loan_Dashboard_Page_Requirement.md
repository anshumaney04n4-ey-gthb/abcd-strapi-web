# Loans CMS Requirements v7 - Personal Loan dashboard Page
...
| Field | Type | Required |
|-------|------|:--------:|
| `newJourney` | new-journey | No |
| `resumeJourney` | resume-journey | No |
| `preApprovedOffer` | pre-approved-offer | No |
| `exclusiveOffer` | exclusive-offer | No |
...
| `headingSuffix` | string | No |
| `items` | get-started-item[] | No |
| `cardBackground` | string | No |
| `cardBorder` | string | No |
...
| `footerLeftIcon` | string | No |
| `footerRightIcon` | string | No |
...
```json
{
    ...
    "items": [
      {
        ...
        "image": "/assets/personal-loan/icons/goldhand.png"
      },
      {
        "id": "repayment-tenure",
        "title": "Repayment Tenure",
        "description": "12 months to 36 months",
        "image": "/assets/personal-loan/icons/percentage.png"
      },
      {
        "id": "rate-of-interest",
      ...
      },
      {
        ...
        "image": "/assets/personal-loan/icons/file.png"
      }
    ],
  ...
  "footer": {
    "referenceDetails": {
      ...
      "logo": "/assets/personal-loan/icons/abc.png",
      "certification": "Aditya Birla Capital Digital Ltd"
    },
    "sideLogoDetails": {
      "image": "/assets/personal-loan/icons/wavesFooter.svg",
